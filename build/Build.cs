...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-playwright";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need playwright on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Playwright.V1.Tests" / "Tamp.Playwright.V1.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Playwright.V1" / "Tamp.Playwright.V1.csproj");
